...
CHECKPOINT = r"C:\Users\IIPL02\Desktop\MRVNet2D\checkpoints\sidd\mrvnet_epoch99.pth"
RESULT_DIR = r"C:\Users\IIPL02\Desktop\MRVNet2D\results\sidd"
...
with torch.no_grad():
    for idx, (dist_img, ref_img) in enumerate(tqdm(test_loader, desc="Testing SIDD")):
