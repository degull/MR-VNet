# E:\MRVNet2D\multiple_distortion\utils_data.py
import numpy as np
import torch
import random
...
distortion_groups = {
    ...
    "spatial_distortion": ["jitter", "noneccpatch", "pixelate", "quantization"],
...
def get_distortions_composition(
    ...
    num_distortions = random.randint(1, min(max_distortions, len(distortion_groups)))
