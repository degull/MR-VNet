...
def main():
    ...
    csv_file = 'gopro_test_pairs.csv'
    save_dir = r'E:/MRVNet2D/results/GOPRO'
    ...
    checkpoint_path = r'./checkpoints/gopro/epoch_99_ssim0.8837_psnr30.22.pth'  # <- 사용하고 싶은 epoch
    ...
    print(f"\n[GOPRO] Test Average PSNR: {avg_psnr:.2f} dB  Average SSIM: {avg_ssim:.4f}")
