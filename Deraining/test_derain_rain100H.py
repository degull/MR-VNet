...
model.load_state_dict(torch.load('./checkpoints/rain100H/epoch_200.pth', map_location=device))
model.eval()
...
print(f"[Rain100H] Results saved to {save_dir}")
