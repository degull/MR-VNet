...
def main():
    ...
    model_path = r'E:\MRVNet2D\checkpoints\rain100H\epoch_99_ssim0.8837_psnr30.22.pth'  # 저장된 pth 사용
    save_dir = r'E:/MRVNet2D/results/Rain100H'
    ...
    # 평균 결과 출력
    print(f"\n[Rain100H] Test Average PSNR: {avg_psnr:.2f} dB  Average SSIM: {avg_ssim:.4f}")
...
# [Rain100H] Test Average PSNR: 30.39 dB  Average SSIM: 0.8825